DROP FUNCTION IF EXISTS canCreateSchedule;
DELIMITER $$
CREATE FUNCTION canCreateSchedule(in_user_id INT(11), in_facility_id INT(11)
...
BEGIN
  ...
  SELECT IF(org_permission_group.name = 'Super Users',1,schedule_create)
  FROM facility
