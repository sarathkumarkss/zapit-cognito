DROP FUNCTION IF EXISTS canDeleteMachineLogFilesNotes;
DELIMITER $$
CREATE FUNCTION canDeleteMachineLogFilesNotes(in_user_id INT(11), in_facility_id INT(11), in_machine_type CHAR(50)) RETURNS BOOLEAN
  DETERMINISTIC
BEGIN
  DECLARE tf BOOLEAN;

  SELECT IF(org_permission_group.name = 'Super Users',1,machinelog_delete_note_file)
  FROM facility
