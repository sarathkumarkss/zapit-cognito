DROP FUNCTION IF EXISTS canCreateMachineLog;
DELIMITER $$
CREATE FUNCTION canCreateMachineLog(in_user_id INT(11), in_facility_id INT(11)
...
BEGIN
  ...
  SELECT IF(org_permission_group.name = 'Super Users',1,machinelog_create)
  FROM facility
