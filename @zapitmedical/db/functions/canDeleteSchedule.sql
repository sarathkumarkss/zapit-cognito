DROP FUNCTION IF EXISTS canDeleteSchedule;
DELIMITER $$
CREATE FUNCTION canDeleteSchedule(in_user_id INT(11), in_facility_id INT(11), in_machine_type CHAR(50)) RETURNS BOOLEAN
  DETERMINISTIC
BEGIN
  DECLARE tf BOOLEAN;

  SELECT IF(org_permission_group.name = 'Super Users',1,schedule_delete)
  FROM facility
